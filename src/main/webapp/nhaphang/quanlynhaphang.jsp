...
<%--                    &lt;%&ndash;Chỉnh UI tab theo đường dẫn&ndash;%&gt;--%>
<%--                    <li class="nav-item">--%>
...
<%--                        &lt;%&ndash;Check xem có bản ghi ko&ndash;%&gt;--%>
<%--                        <%--%>
...
<%--    </div>--%>
<%--</div>--%>
<%--&lt;%&ndash;<div id="popupNotify">&ndash;%&gt;--%>
<%--&lt;%&ndash;    <div id="popupNotifyBody">&ndash;%&gt;--%>
<%--&lt;%&ndash;    </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;</div>&ndash;%&gt;--%>
